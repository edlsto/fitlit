...
new Chart(document.getElementById('admin-hydration').getContext('2d'), {
  type: 'line',
  data: {
    labels: hydration.calculateHydrationAvgForAllUsersForLastMonth(today).map(el => el.date).reverse(),
    datasets: [{
      label: 'Hydration',
      data: hydration.calculateHydrationAvgForAllUsersForLastMonth(today).map(el => el.averageNumOunces).reverse(),
      backgroundColor: [
        '#49A0AD'
      ],
      borderColor: [
...
new Chart(document.getElementById('admin-sleep').getContext('2d'), {
  type: 'bar',
  data: {
...
new Chart(document.getElementById('admin-activity1').getContext('2d'), {
  type: 'bar',
  data: {
